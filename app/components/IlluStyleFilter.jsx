...
const IlluStyleFilter = () => {
  ...
  return (
    <div className="container">
      <div className="outline outline-1 p-5 outline-gray-300 rounded-xl md:float-left">
      ...
      <div className="max-[1280px]:hidden outline outline-3 p-10 md:mr-32 md:mt-14 outline-gray-300 rounded-xl md:float-right ">
